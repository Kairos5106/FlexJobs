 ...
 * @version 4.0.3
 */
var GetWorkspaces200Response = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetWorkspaces200Response</code>.
   * @alias module:model/GetWorkspaces200Response
   */
  function GetWorkspaces200Response() {
    _classCallCheck(this, GetWorkspaces200Response);
  ...
  _createClass(GetWorkspaces200Response, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('response')) {
          obj['response'] = _ApiClient["default"].convertToType(data['response'], [_Workspace["default"]]);
        }
    ...
    value: function validateJSON(data) {
      if (data['response']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Workspace["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      if (data['meta']) {
        // data not null
        _PaginationMeta["default"].validateJSON(data['meta']);
      }
...
var _default = GetWorkspaces200Response;
